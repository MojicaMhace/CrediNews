...
CREDIBLE_WEBSITES: Dict[str, Dict[str, Any]] = {
    ...
    'rappler.com':      {'score': 0.20, 'name': 'Rappler'},
    'inquirer.net':     {'score': 0.20, 'name': 'Inquirer.net'},
    'news.abs-cbn.com': {'score': 0.20, 'name': 'ABS-CBN News'},
    'gmanetwork.com':   {'score': 0.20, 'name': 'GMA Network'},
    'philstar.com':     {'score': 0.20, 'name': 'Philstar.com'},
    'mb.com.ph':        {'score': 0.20, 'name': 'Manila Bulletin'},
    'bworldonline.com': {'score': 0.20, 'name': 'BusinessWorld'},
    'verafiles.org':    {'score': 0.20, 'name': 'VERA Files'},

    # --- PHILIPPINES: Broadcasters & Aggregators ---
    'cnnphilippines.com':       {'score': 0.20, 'name': 'CNN Philippines (Archived)'},
    ...
    'reuters.com':   {'score': 0.20, 'name': 'Reuters'},
    'apnews.com':    {'score': 0.20, 'name': 'Associated Press (AP)'},
    'afp.com':       {'score': 0.20, 'name': 'Agence France-Presse (AFP)'},
    'bloomberg.com': {'score': 0.20, 'name': 'Bloomberg'},

    # --- INTERNATIONAL: Prestige Global Media (Tier 1) ---
    'bbc.com':            {'score': 0.20, 'name': 'BBC News'},
    'bbc.co.uk':          {'score': 0.20, 'name': 'BBC News (UK)'},
    'cnn.com':            {'score': 0.20, 'name': 'CNN International'},
    'nytimes.com':        {'score': 0.20, 'name': 'The New York Times'},
    'washingtonpost.com': {'score': 0.20, 'name': 'The Washington Post'},
    'wsj.com':            {'score': 0.20, 'name': 'The Wall Street Journal'},
    'aljazeera.com':      {'score': 0.20, 'name': 'Al Jazeera'},
    'dw.com':             {'score': 0.20, 'name': 'Deutsche Welle (DW)'},
    'france24.com':       {'score': 0.20, 'name': 'France 24'},
    'npr.org':            {'score': 0.20, 'name': 'NPR (National Public Radio)'},
...
CREDIBLE_SOCIAL_PATTERNS: List[Dict[str, Any]] = [
    ...
    {'pattern': r"facebook\.com/OfficeOfThePresidentPH",      'score': 0.20, 'name': 'Office of the President (Official)'},
    {'pattern': r"facebook\.com/pcogovph",                    'score': 0.20, 'name': 'Presidential Comms Office (Official)'},
    {'pattern': r"facebook\.com/dilg\.philippines",           'score': 0.20, 'name': 'DILG Philippines (Official)'},
    {'pattern': r"facebook\.com/dfaphl",                      'score': 0.20, 'name': 'DFA (Foreign Affairs)'},

    # --- PHILIPPINES: Government (Social Services) ---
    {'pattern': r"facebook\.com/(OfficialDOHgov|DepartmentOfHealthPhilippines)", 'score': 0.20, 'name': 'DOH (Health Official)'},
    {'pattern': r"facebook\.com/DepartmentOfEducation\.PH",   'score': 0.20, 'name': 'DepEd (Education Official)'},
    {'pattern': r"facebook\.com/dswdserves",                  'score': 0.20, 'name': 'DSWD (Social Welfare Official)'},
    {'pattern': r"facebook\.com/laborandemployment",          'score': 0.20, 'name': 'DOLE (Labor Official)'},
    {'pattern': r"facebook\.com/dmw\.gov\.ph",                'score': 0.20, 'name': 'DMW (Migrant Workers Official)'},

    # --- PHILIPPINES: Government (Economic & Infrastructure) ---
    {'pattern': r"facebook\.com/DepartmentOfFinancePH",       'score': 0.20, 'name': 'DOF (Finance Official)'},
    {'pattern': r"facebook\.com/BangkoSentralngPilipinas",    'score': 0.20, 'name': 'Bangko Sentral (Central Bank)'},
    {'pattern': r"facebook\.com/DTI\.Philippines",            'score': 0.20, 'name': 'DTI (Trade & Industry)'},
    {'pattern': r"facebook\.com/DOTrPH",                      'score': 0.20, 'name': 'DOTr (Transportation)'},
    {'pattern': r"facebook\.com/dpwhph",                      'score': 0.20, 'name': 'DPWH (Public Works)'},
    {'pattern': r"facebook\.com/NEDAhq",                      'score': 0.20, 'name': 'NEDA (Economic Authority)'},

    # --- PHILIPPINES: Government (Safety, Science & Disaster) ---
    {'pattern': r"facebook\.com/PAGASA\.DOST\.GOV\.PH",       'score': 0.20, 'name': 'PAGASA (Weather Official)'},
    {'pattern': r"facebook\.com/PHIVOLCS",                    'score': 0.20, 'name': 'PHIVOLCS (Volcano/Quake Official)'},
    {'pattern': r"facebook\.com/civildefensePH",              'score': 0.20, 'name': 'OCD (Civil Defense/Disaster)'},
    {'pattern': r"facebook\.com/MMDAPH",                      'score': 0.20, 'name': 'MMDA (Metro Manila)'},

    # --- PHILIPPINES: Facebook Handles (Media) ---
    {'pattern': r"facebook\.com/(rapplerdotcom|rappler)",     'score': 0.20, 'name': 'Rappler (Facebook)'},
    {'pattern': r"facebook\.com/inquirerdotnet",              'score': 0.20, 'name': 'Inquirer.net (Facebook)'},
    {'pattern': r"facebook\.com/abscbnNEWS",                  'score': 0.20, 'name': 'ABS-CBN News (Facebook)'},
    {'pattern': r"facebook\.com/gmanews",                     'score': 0.20, 'name': 'GMA News (Facebook)'},
    {'pattern': r"facebook\.com/PhilippineStar",              'score': 0.20, 'name': 'The Philippine Star (Facebook)'},
    {'pattern': r"facebook\.com/manilabulletin",              'score': 0.20, 'name': 'Manila Bulletin (Facebook)'},
    {'pattern': r"facebook\.com/BusinessWorldOnline",         'score': 0.20, 'name': 'BusinessWorld (Facebook)'},
    {'pattern': r"facebook\.com/verafiles",                   'score': 0.20, 'name': 'VERA Files (Facebook)'},
    {'pattern': r"facebook\.com/rapplerlife",                 'score': 0.20, 'name': 'Rappler Life (Facebook)'},

    # --- BIÑAN CITY, LAGUNA: Local Government Unit (LGU) ---
    {'pattern': r"facebook\.com/CIOBinan",                   'score': 0.20, 'name': 'Biñan City Info Office (Official LGU)'},
    {'pattern': r"facebook\.com/SerbisyongArman",            'score': 0.20, 'name': 'Mayor Arman Dimaguila (Official)'},
    {'pattern': r"facebook\.com/TatakGel",                   'score': 0.20, 'name': 'Vice Mayor Gel Alonte (Official)'},
    {'pattern': r"facebook\.com/LenAlonte",                  'score': 0.20, 'name': 'Rep. Len Alonte (Lone District)'},
    {'pattern': r"facebook\.com/BinanCityDRRMO",             'score': 0.20, 'name': 'Biñan CDRRMO (Disaster/Rescue)'},
    {'pattern': r"facebook\.com/BinanCPS",                   'score': 0.20, 'name': 'Biñan City Police Station (PNP)'},
    {'pattern': r"facebook\.com/POSOBinan",                  'score': 0.20, 'name': 'POSO Biñan (Traffic/Safety)'},
    {'pattern': r"facebook\.com/BCHOOfficial",               'score': 0.20, 'name': 'Biñan City Health Office (Health)'},
    ...
    {'pattern': r"facebook\.com/Reuters",                     'score': 0.20, 'name': 'Reuters (Facebook)'},
    {'pattern': r"facebook\.com/APNews",                      'score': 0.20, 'name': 'Associated Press (Facebook)'},
    {'pattern': r"facebook\.com/AFPnewsenglish",              'score': 0.20, 'name': 'AFP News (Facebook)'},
    {'pattern': r"facebook\.com/bbcnews",                     'score': 0.20, 'name': 'BBC News (Facebook)'},
    {'pattern': r"facebook\.com/cnn",                         'score': 0.20, 'name': 'CNN (Facebook)'},
    {'pattern': r"facebook\.com/nytimes",                     'score': 0.20, 'name': 'New York Times (Facebook)'},
    {'pattern': r"facebook\.com/washingtonpost",              'score': 0.20, 'name': 'Washington Post (Facebook)'},
    {'pattern': r"facebook\.com/bloombergbusiness",           'score': 0.20, 'name': 'Bloomberg Business (Facebook)'},
    {'pattern': r"facebook\.com/aljazeera",                   'score': 0.20, 'name': 'Al Jazeera (Facebook)'},
    {'pattern': r"facebook\.com/dw\.deutschewelle",           'score': 0.20, 'name': 'DW Deutsche Welle (Facebook)'},
